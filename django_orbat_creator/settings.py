"""
Django settings for django_orbat_creator project.
...
ROOT_URLCONF = 'django_orbat_creator.urls'
...
WSGI_APPLICATION = 'django_orbat_creator.wsgi.application'
